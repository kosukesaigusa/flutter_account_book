...
abstract class $FirebaseTaskResultCopyWith<T, $Res> {
  factory $FirebaseTaskResultCopyWith(FirebaseTaskResult<T> value,
      ...
      _$FirebaseTaskResultCopyWithImpl<T, $Res, FirebaseTaskResult<T>>;
}

/// @nodoc
class _$FirebaseTaskResultCopyWithImpl<T, $Res,
        $Val extends FirebaseTaskResult<T>>
...
class __$$SuccessCopyWithImpl<T, $Res>
    extends _$FirebaseTaskResultCopyWithImpl<T, $Res, _$Success<T>>
...
class _$Success<T> implements Success<T> {
  ...
  int get hashCode => Object.hash(runtimeType,
      const DeepCollectionEquality().hash(contents), message, success);
...
class __$$FailureCopyWithImpl<T, $Res>
    extends _$FirebaseTaskResultCopyWithImpl<T, $Res, _$Failure<T>>
...
class __$$ErrorCopyWithImpl<T, $Res>
    extends _$FirebaseTaskResultCopyWithImpl<T, $Res, _$Error<T>>
