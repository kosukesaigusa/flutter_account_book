...
_$_IncomeCategory _$_$_IncomeCategoryFromJson(Map<String, dynamic> json) {
  return _$_IncomeCategory(
...
Map<String, dynamic> _$_$_IncomeCategoryToJson(_$_IncomeCategory instance) =>
    <String, dynamic>{
      'reference':
